...
/* 0x50 */	push_eax, push_ecx, push_edx, push_ebx,
/* 0x54 */	push_esp, push_ebp, push_esi, push_edi,
...
/* 0x84 */	test_rm_b, test_rm_v, inv, inv,//test
...
/* 0xe8 */	call_i_v, inv, inv, inv,//call
